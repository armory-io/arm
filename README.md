...
| dinghyfile_dict_range_example               | :white_check_mark: | :x:                | :x:                | dinghy render ./examples/json/dinghyfile_dict_range_example --modules ./examples/json/modules                        |
| dinghyfile_list_range_example               | :white_check_mark: | :x:                | :x:                | dinghy render ./examples/json/dinghyfile_list_range_example --modules ./examples/json/modules                        |
...
| dinghyfile_dict_range_example               | :white_check_mark: | :x:                | :x:                | dinghy render ./examples/yaml/dinghyfile_dict_range_example --modules ./examples/yaml/modules --type yaml                       |
| dinghyfile_list_range_example               | :white_check_mark: | :x:                | :x:                | dinghy render ./examples/yaml/dinghyfile_list_range_example --modules ./examples/yaml/modules --type yaml                       |
